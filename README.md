...
| Criterio específico | Acciones realizadas | Conclusiones |
| ----- | ----- | ----- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | <br/><br/>Liderazgo distribuido TF1:<br/>- Irving (U202213241) lideró la documentación del Sprint 4.<br/>- Mariano (U202310222) asumió múltiples responsabilidades técnicas clave: conexión Front-Back, correcciones de endpoints y frontend, además de la edición en Canvas para el video.<br/>- Diego Seijas (U202210167) lideró la documentación de la API con Swagger y el rediseño de la landing page en Figma.<br/>- Diego Cacho (U202223990) verificó aspectos clave del frontend como comentarios, índice y ajustes de imágenes.<br/><br/>Coordinación general:<br/>- Se distribuyeron tareas de manera clara y se ejecutaron en su mayoría en los tiempos estimados.<br/>- La colaboración se mantuvo activa entre los dominios de desarrollo, documentación y diseño. | El liderazgo compartido se sostuvo en TF1, con mayor énfasis en la ejecución técnica detallada. Cada miembro asumió responsabilidades con autonomía. Se notó un incremento en la proactividad individual. Se recomienda en adelante promover aún más la revisión cruzada entre pares para asegurar calidad transversal. |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | <br/><br/>Metodología de trabajo en TF1:<br/>- Se mantuvo la estructura de trabajo por dominios, ahora orientada a tareas específicas del sprint.<br/>- Se realizaron correcciones de diseño (Landing Page, atributos Aria, imágenes) y mejoras funcionales (autenticación JWT, conexión front-back, documentación en Swagger).<br/>Aportes individuales destacados:<br/>- Giancarlo (U202318615): corrección de atributos Aria y comentarios en Swagger.<br/>- Bryan (U202316246): actualización de diseño UX/UI en el documento.<br/>- Renato (U202317566): implementación de autenticación JWT y entrega del Figma actualizado del frontend.<br/><br/>Herramientas utilizadas:<br/>- GitHub, Discord, Figma, Swagger, Canvas. | El equipo mantuvo un entorno colaborativo funcional, centrado en cerrar tareas pendientes con alto nivel técnico. La inclusión se fortaleció a través del soporte entre compañeros en tareas como Swagger y diseño. Como mejora, se sugiere establecer mecanismos visuales de planificación más dinámicos para facilitar seguimiento y priorización. |
